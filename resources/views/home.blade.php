...
<html lang="en">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a onclick="event.preventDefault();
              document.getElementById('logout-form').submit();" href="{{ route('logout') }}" class="nav-link">logout</a></li>
		  ...
		  <div class="dropdown">
			<a class="btn btn-secondary dropdown-toggle notification" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<span class="icon-add_alert"></span> [{{ Session::get('notification_number')}}]
			</a>
		  
			<div class="dropdown-menu" aria-labelledby="dropdownMenuLink" id="noti">
				@foreach($notifications as $noti)
			  <a class="dropdown-item" href="{{ $noti->header }}">
			{{ $noti->title }}
    	...
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            @foreach($products as $product)
              <div class="item">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="{{ url('/getImage/'.$product->id) }}" alt="Colorlib Template" style="width: 300px;height: 300px">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This project is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by Mohamed Zaki</a>
  ...
  $(document).ready(function(){
	...
	setInterval(get_notitifications,5000);

function get_notitifications(){
...
success: function(data){
 ...
 $("#noti").prepend(data.message);
 //<span  class="icon-shopping_cart"></span>
 $(".notification").html('<span  class="icon-add_alert"></span>['+data.number+']');
