	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li  class="nav-item cta cta-colored"><a id="cartnumber"  href="cart.html" class="nav-link"><span  class="icon-shopping_cart"></span>[{{ Session::get('cart_number') }}]</a></li>
    	...
    	<div class="container-fluid">
    		<div class="row">
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="{{ url('/product/'.$product->id) }}" class="img-prod"><img class="img-fluid" style="width: 300px;height: 300px" src=" {{ url('/getImage/'.$product->id) }} " alt="Colorlib Template">
    					...
    					<div class="text py-3 px-3">
    						...
    						<p class="bottom-area d-flex">
    							<a href="" id="addcart" data-value="{{ $product->id }}" class="add-to-cart"><span>Add to cart <i class="ion-ios-add ml-1"></i></span></a>
