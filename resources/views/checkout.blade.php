...
<form method="POST" action="{{ url('/payment/'.$products_total) }}">
	          		...
	          		<div class="cart-detail bg-light p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2" checked="checked" value="delevery"> Direct Pay On Delivery</label>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2" value="cridet"> Check Ceridet Payment</label>
											</div>
										</div>
									</div>
...
<div class="container">
	...
	<form action="{{ url('/criditpayment/'.$products_total) }}" method="post" id="payment-form">
		@csrf
		<div class="form-row">
...
var stripe = Stripe('pk_test_d9iBzdCfBQr0sSi44Ukrg2FV00UDSO6xqz');
