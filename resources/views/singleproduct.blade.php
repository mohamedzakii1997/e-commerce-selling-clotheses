	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta cta-colored"><a href="cart.html" class="nav-link" id="cartnumber"><span class="icon-shopping_cart"></span>[{{ Session::get('cart_number') }}]</a></li>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/menu-2.jpg" class="image-popup"><img src="{{ url('/getImage/'.$product->id) }}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
          	...
          	<p><a id="addcart" data-value="{{ $product->id }}" class="btn btn-primary py-3 px-5">Add to Cart</a></p>
    			</div>
    		</div>
    	</div>
    </section>
