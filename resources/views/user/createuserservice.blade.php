      ...
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5>Assign -Services To {{ $user->name }}</h5>
          </div>
          <div class="widget-content nopadding">
            <form action="{{ url('/submitservice/'.$user->id) }}" method="post" class="form-horizontal">
              @csrf
                <div class="control-group">
                <label class="control-label"> Title :</label>
                <div class="controls">
                  <input type="text" class="span11" placeholder=" add title" name="title" />
                </div>
              </div>


              <div class="control-group">
                    <label class="control-label">Our Services</label>
                    <div class="controls">
                        @foreach($ser as $s)
                      <label>
                        <input type="radio" value="{{ $s->id }}" name="radios" />
                        {{ $s->type }}</label>
                      @endforeach
                    </div>
                  </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" placeholder="your url" name="url" />
                </div>
              </div>
